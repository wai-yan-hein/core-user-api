...
public interface RolePropertyRepo extends JpaRepository<RoleProperty, RolePropertyKey> {
    @Query("select o from RoleProperty o where o.key.roleCode = :roleCode and o.key.compCode = :compCode")
    List<RoleProperty> getRoleProperty(@Param("roleCode") String roleCode,@Param("compCode") String compCode);
